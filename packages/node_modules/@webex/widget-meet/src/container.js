...
function MeetWidget({
  intl,
  displayName = 'WidgetMeetEnhancers',
  isIncoming,
  avatarImage,
  meeting,
  widgetMeet,
  ...
  //const spaceDetails = useSelector(getMeetWidgetProps);
  const {avatarId} = spaceDetails;


  function renderIsIncoming() {
    return (
      <div className={classNames(styles.meetWidgetContainer, 'meet-widget-container')}>
        ...
        <Notifications onEvent={handleEvent} isMuted={muteNotifications} />
      </div>
    );
  }
